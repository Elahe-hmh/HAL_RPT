...
//        deltas[IMMUNE]=-immuneDeathRate*pops[IMMUNE]+immuneRecrutimentRate*pops[TUMOR]*pops[IMMUNE];
        deltas[TUMOR] = 0.5*pops[IMMUNE]+10*Math.exp(-Math.pow(t-10,2)/0.01);
        deltas[IMMUNE] = -0.5*pops[TUMOR];
    }
    ...
    public static void main(String[] args) {
        ...
        solver.Runge45(model::PopulationDerivatives,states,ts,50,dtStart,errorTol,0);
